...
import { Github, Linkedin, Mail, Phone, Download, Code, Server, Cpu, Cloud, Database, Terminal, ChevronRight, ExternalLink, Menu, X } from 'lucide-react';
  ...
  const projects = [
    {
      ...
      description: 'Distributed system with Docker, MongoDB, Apache Kafka, and gRPC for fault-tolerant operations',
    ...
    },
    {
      ...
      description: 'Non-invasive GLURAKOL monitoring with Python, Arduino/ESP32, and real-time MQTT cloud integration',
      tech: ['Python', 'Arduino', 'ESP32', 'MQTT', 'Sensors'],
      icon: Cpu,
      color: 'from-purple-500 to-pink-500',
      highlights: ['Real-time Monitoring', 'Cloud Integration', 'Data Analytics']
    },
    {
      title: 'Automated Server Configuration',
      category: 'DevOps',
      description: 'Ansible-based automation for DNS, HTTP, SMTP, SSH, and Proxy servers across VMs',
      tech: ['Ansible', 'Linux', 'Networking', 'Infrastructure as Code'],
      icon: Terminal,
      color: 'from-green-500 to-emerald-500',
      highlights: ['Infrastructure Automation', 'Multi-Server Management', 'Scalable Deployment']
    },
    {
      title: 'Healthcare Information Platform',
      category: 'Full Stack',
      description: 'Web-based system centralizing healthcare facilities data across multiple cities',
    ...
    },
    {
      ...
      category: 'Full Stack',
      description: 'Dynamic web system with PHP/MySQL backend and secure RESTful APIs',
    ...
    },
    {
      ...
      description: 'Arduino-based prototype with rainfall and LDR sensors for environmental adaptation',
      tech: ['Arduino', 'IoT', 'Sensors', 'Wireless Control'],
      icon: Cloud,
      color: 'from-teal-500 to-cyan-500',
      highlights: ['Sensor Integration', 'Real-time Response', 'Automated Control']
    }
  ];

  const techStack = [
    { category: 'Languages', items: ['Python', 'PHP', 'C/C++', 'JavaScript', 'SQL'] },
    { category: 'Backend', items: ['Node.js', 'Express', 'REST API', 'gRPC'] },
    { category: 'Database', items: ['MySQL', 'MongoDB', 'PostgreSQL'] },
    { category: 'DevOps', items: ['Docker', 'Ansible', 'Linux', 'Apache Kafka'] },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-8 leading-relaxed">
                Final-year Computer Technology student passionate about building scalable systems, 
                IoT solutions, and automated infrastructure. Experienced in microservices, 
                distributed systems, and modern development practices.
              </p>
              ...
              <div className="flex gap-4 mt-8">
                ...
                <a href="https://www.linkedin.com/in/dwinainggolan" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  <Linkedin size={24} />
                </a>
                <a href="mailto:dwigolan@gmail.com" className="text-gray-400 hover:text-cyan-400 transition-colors">
                  <Mail size={24} />
                </a>
              </div>
            </div>
                ...
                <div className="w-full h-96 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg backdrop-blur-sm border border-cyan-500/30 p-8">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <span className="text-gray-300">Available for Internship</span>
                    </div>
                    <div className="space-y-2">
                      <div className="text-gray-400 text-sm">Current Focus:</div>
                      <div className="flex flex-wrap gap-2">
                        {['Microservices', 'IoT', 'DevOps', 'API Design'].map((tag) => (
                          <span key={tag} className="px-3 py-1 bg-gray-800 rounded-full text-xs text-cyan-400">
                            {tag}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="pt-4 border-t border-gray-700">
                      <div className="text-gray-400 text-sm mb-2">Quick Stats:</div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                I'm a final-year Associate Degree student in Computer Technology at IT Del with a 
                strong passion for building robust, scalable systems. My experience spans across 
                full-stack development, IoT solutions, microservices architecture, and DevOps practices.
              </p>
              <p className="text-gray-300 leading-relaxed mb-4">
                I thrive on solving complex technical challenges and implementing modern development 
                practices. From building distributed systems with Docker and Kafka to creating 
                IoT solutions with Arduino and ESP32, I enjoy working across the entire technology stack.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-cyan-500/50 transition-all">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Building complete web applications with modern frameworks, RESTful APIs, and database design</p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-blue-500/50 transition-all">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold mb-2">Backend Engineering</h4>
                      <p className="text-sm text-gray-400">Designing scalable microservices, distributed systems, and event-driven architectures</p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-all">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Creating embedded systems with Arduino/ESP32, sensor integration, and cloud connectivity</p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 hover:border-green-500/50 transition-all">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Automating infrastructure with Docker, Ansible, and implementing CI/CD pipelines</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((tech, i) => (
                        <span key={i} className="text-xs bg-gray-900 text-cyan-400 px-2 py-1 rounded">
                          {tech}
                        </span>
                      ))}
                    </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-gray-900 p-6 rounded-lg border border-cyan-500/30">
              <h3 className="text-xl font-semibold mb-4 text-cyan-400">Full Stack</h3>
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-purple-500/30">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">IoT</h3>
              {skills.iot.map((skill, i) => (
                <SkillBar key={i} {...skill} />
              ))}
            </div>
            <div className="bg-gray-900 p-6 rounded-lg border border-green-500/30">
              <h3 className="text-xl font-semibold mb-4 text-green-400">DevOps</h3>
                ...
                <div key={i}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.items.map((item, j) => (
                      <span key={j} className="bg-gray-800 px-3 py-1 rounded text-sm text-gray-300">
                        {item}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-cyan-500/50 transition-all">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                      ...
                      <a href="mailto:dwigolan@gmail.com" className="text-cyan-400 hover:underline">
                        dwigolan@gmail.com
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-cyan-500/50 transition-all">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                      ...
                      <a href="tel:+62895612419871" className="text-cyan-400 hover:underline">
                        +62 895 6124 19871
                      </a>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
                      <span className="font-semibold">Internship Positions</span>
                    </div>
                  ...
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                    ...
                    <div className="text-sm text-gray-400">Open to remote and on-site opportunities</div>
                  </div>
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                    <div className="font-semibold mb-2">Availability</div>
                    <div className="text-sm text-gray-400">Ready to start immediately</div>
                  </div>
